        ...
        <div className="flex-col flex self-center lg:px-14 sm:max-w-4xl xl:max-w-md z-10">
          <div className="self-start hidden lg:flex flex-col text-gray-300">
            ...
            <p className="pr-3 text-sm opacity-75 text-black">
              ...
              enjoy a seamless shopping experience. Whether you're looking for
              the latest trends, essential items, or exclusive deals, logging in
              will unlock a personalized experience just for you.
            </p>
          </div>
        </div>
